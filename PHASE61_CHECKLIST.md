# Phase 61 - Client Broker-State Execution Visibility

- [x] Audit client trade-history and dashboard helpers for missing `SENT` visibility after the server-side follow-up changes
- [x] Distinguish broker-submission waits from acknowledged fill waits in lifecycle overview and attention-card summaries
